        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="/products">Menu</a></li>
                    <li class="nav-item"><a class="nav-link" href="/checks">Check Out</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="/signup">Sign Up</a></li>
                </ul>
                <form class="d-flex">
